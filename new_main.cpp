...
int main()
{
	...
	p.execute_move(2,"P 0 0" , b);
	p.execute_move(1,"P 1 1" , b);
	p.execute_move(2,"P 1 2" , b);
	p.execute_move(1,"P 2 9" , b);
	p.execute_move(2,"P 1 3" , b);
	p.execute_move(1,"P 3 11" , b);
	p.execute_move(2,"P 1 4" , b);
	p.execute_move(1,"P 2 10" , b);
	...
	p.execute_move(2,"S 1 2 M 2 5" , b);
	...
	print_board(b);
	 vector<string> v = p.generate_neighbour(2,b);
	//  cout << v.size() << endl ;
